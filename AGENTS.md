...
- **Descriptive Naming**: Function names should clearly communicate intent without becoming sentence-length. Use domain terms and the surrounding class/context to keep names concise; avoid repeating information that is already obvious from the file, class, parameters, or call site.
